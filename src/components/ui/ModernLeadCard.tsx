...
export function ModernLeadCard({ lead, onClick }: ModernLeadCardProps) {
  ...
  return (
    <div 
      onClick={onClick}
      className="native-card bg-surface-card border border-border-subtle overflow-hidden flex flex-col sm:flex-row group hover:border-primary-main/30 hover:shadow-md transition-all duration-300 cursor-pointer active:scale-[0.99] rounded-xl sm:h-32"
    >
      {/* Photo / Thumbnail */}
      <div className="relative w-full sm:w-48 h-48 sm:h-full bg-bg-base overflow-hidden shrink-0 border-b sm:border-b-0 sm:border-r border-border-subtle/20">
        {photo ? (
          <img 
            src={photo} 
      ...
      <div className="p-3 sm:p-4 flex flex-col justify-between flex-1 min-w-0">
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            <h3 className="text-[14px] sm:text-[15px] font-bold text-text-main tracking-tight leading-tight group-hover:text-primary-main transition-colors truncate">
              {lead.vehicle}
            </h3>
          ...
          <div className="text-right shrink-0">
            ...
            <p className="text-[14px] sm:text-[16px] font-black text-text-main tracking-tight leading-none">
        ...
        <div className="flex items-center justify-between pt-3 mt-3 border-t border-border-subtle/30">
          ...
          <div className="flex items-center gap-1 text-[10px] font-bold uppercase tracking-widest text-primary-main group-hover:translate-x-1 transition-transform shrink-0 opacity-0 group-hover:opacity-100">
