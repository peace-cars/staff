...
export function InspectionSheets({
  ...
  return (
    <>
      {/* Checklist Sheet (Exterior / Interior / Mechanical) */}
      <BottomSheet
        ...
        footer={
          <button
            ...
            className="w-full py-4 rounded-2xl bg-primary-main text-white font-bold text-sm hover:bg-primary-main/90 active:scale-95 transition-transform"
          >
            Done
          </button>
        }
      >
        {activeSheet && activeSheet !== 'summary' && activeSheet !== 'ev' && (
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-3 bg-surface-hover border border-border-subtle rounded-2xl mb-4">
            ...
            <div className="pt-6 space-y-4">
              <p className="text-[10px] font-bold text-text-secondary uppercase tracking-widest px-1">Manual Grade Override</p>
              <div className="bg-surface-hover p-5 rounded-3xl border border-border-subtle">
        ...
        footer={
          <div className="space-y-3">
            <button
              ...
              className="w-full py-4 rounded-2xl bg-primary-main text-white font-bold text-sm hover:bg-primary-main/90 active:scale-95 transition-all flex items-center justify-center gap-2 shadow-lg disabled:opacity-60"
            >
            ...
            {isDM && (
              <button
                ...
                disabled={isSubmitting}
                className="w-full py-4 rounded-2xl bg-emerald-500 text-white font-bold text-sm hover:bg-emerald-600 active:scale-95 transition-all flex items-center justify-center gap-2 shadow-lg shadow-emerald-500/30 disabled:opacity-60"
              >
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <textarea
              ...
              className="w-full bg-surface-hover border border-border-subtle rounded-3xl p-5 text-sm min-h-[140px] focus:outline-none focus:border-primary-main text-text-main transition-all resize-none placeholder:text-text-muted"
            />
          </div>
        </div>
      </BottomSheet>
